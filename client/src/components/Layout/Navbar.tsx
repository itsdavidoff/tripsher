    ...
    <nav style={{
      ...
      <div className="flex items-center gap-3 min-w-0">
        ...
        <Link to="/dashboard" className="flex items-center transition-colors flex-shrink-0">
          <img src={dark ? '/logo-dark.svg' : '/logo-light.svg'} alt="Tripsher" className="hidden sm:block" style={{ height: 28 }} />
          <img src={dark ? '/logo-dark.svg' : '/logo-light.svg'} alt="Tripsher" className="sm:hidden" style={{ height: 24 }} />
        </Link>
