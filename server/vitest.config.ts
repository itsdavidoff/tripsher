...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@modelcontextprotocol/sdk/server/mcp': fileURLToPath(
        new URL('../node_modules/@modelcontextprotocol/sdk/dist/cjs/server/mcp.js', import.meta.url)
      ),
      '@modelcontextprotocol/sdk/server/streamableHttp': fileURLToPath(
        new URL('../node_modules/@modelcontextprotocol/sdk/dist/cjs/server/streamableHttp.js', import.meta.url)
      ),
      '@modelcontextprotocol/sdk/inMemory': fileURLToPath(
        new URL('../node_modules/@modelcontextprotocol/sdk/dist/cjs/inMemory.js', import.meta.url)
      ),
      '@modelcontextprotocol/sdk/client/index': fileURLToPath(
        new URL('../node_modules/@modelcontextprotocol/sdk/dist/cjs/client/index.js', import.meta.url)
      ),
    },
  },
});